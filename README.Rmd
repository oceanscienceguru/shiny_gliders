...
Generated using the batteryMarkdown.Rmd script in Documentation. A dedicated cron job runs this markdown script via batteryMarkdownGenerate.R for each glider listed under the controlling file called "processGliders.txt". This is then saved as an html file and emailed out daily using a separate cron job to a given list of emails.
